...
print <<EOM;
				<div id="notes">
					...
					Your nucleotide sequence will be searched for unique restriction sites, which will be used to divide the sequence into building blocks of approximately 750bp.<br>
					...
					&nbsp;&nbsp;&bull;Chunk overlap refers to how many bp will be shared in adjacent buildin blocks.  For instance, with a 20bp chunk overlap, if a 6bp cutter is
